        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div class="max-w-3xl">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="{{ route('dashboard') }}" id="cta-primary" class="bg-orange-600 hover:bg-orange-500 px-8 py-4 rounded-full font-semibold text-lg transition transform hover:scale-105 shadow-lg inline-flex items-center gap-2">
                        <i class="fas fa-paper-plane"></i>
                        <span id="cta-primary-text">Request shipment now</span>
                    </a>
